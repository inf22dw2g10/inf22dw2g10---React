    ...
    <>
      <div className="form-wrapper">
        <form action="" method="post" onSubmit={handleSubmit(registerSubmit)}>
          <h1>Register</h1>
          <h3 className="form-success-message">{registrationSuccessful &&  "Registration Successful, You will be redirect to login page"}</h3>
          ...
          <p><input type="pasword" name="password" placeholder="Password"  autoComplete="off" {...register("password")}/></p>
          ...
          <p className="form-error-message">{errors.repeatPassword?.message}</p>
